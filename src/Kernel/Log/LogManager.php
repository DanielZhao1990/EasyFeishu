...
namespace EasyFeishu\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('EasyFeishu', $this->prepareHandlers([new StreamHandler(
    ...
    {
        return new Monolog('EasyFeishu', [new NullHandler()]);
    }
